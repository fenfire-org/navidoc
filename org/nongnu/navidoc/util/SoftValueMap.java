...
/** A map where the <em>values</em> are referred to by soft references -- useful for
 * caches.
 * Modern JVM garbage collectors (contrary to folklore dating from the 1.2 era)
 * seem to support soft references properly, with LRU semantics.
 * This class uses them to implement a memory-sensitive cache.
 * <p>
 * The JDK should really provide this...
 */
public class SoftValueMap extends RefValueMap {

    private static class Value extends SoftReference implements Map.Entry{
	private Object k;
